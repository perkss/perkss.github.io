...
const home = {
   ...
   title: 'The Perks of Computer Science',
    ...
    text: [<div><p>Hello and congratulations on finding <strong>The Perks of Computer Science</strong>. This blog will become a treasure chest of technical and mathematical knowledge for all those interested in computer science and programming to use. Suitable for all but especially for those who like to learn with all the details and solid examples, no more algorithm teachers assumptions.</p>
                                                                                                                                                                                       ...
                                                                                                                                                                                       <p>Please check the side menu on the top left. We will be covering the <strong>Fundamentals of Mathematics&#39;s</strong> starting with some BiteSize Maths a few Prerequisites from Stanford and finally looking in depth at the book Concrete Mathematics. A study of <strong>Mathematics for Computer Science</strong> using course content from MIT and Stanford follows using the fundamental knowledge. <strong>Algorithms</strong> will then be discussed in detail buidling them imperatively and functionally using C and Clojure respectively. We will then dig into the world of <strong>Functional Programming</strong> using the text book the Structure and Interpretation of Computer Programs (SICP) as the basis and Clojure as the main language. Check out <strong>A Little bit of C Programming</strong> for some Pointer Madness. Which will then lead to some <strong>Programming Pearls</strong> for all to learn from a case study of the book.</p>

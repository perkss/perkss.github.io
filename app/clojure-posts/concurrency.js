...
const ConcurrencyClojure = () => (
		...
		<h4>Delays</h4>
		<p>Delays enable the suspension of some body of code and evaluating it on demand so when deref is called or force. This body will only be evalauted once so its result is cached for fast future responses. This enables delaying some potential costly function call until its absolutely necessary to call.</p>

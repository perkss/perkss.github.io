...
const BiteSizeMath = () => (
    ...
    <div>
        ...
        <ul className="text-list">
            ...
            <li><Link to={"#basicgeometry"}>Basic Geometry</Link></li>
            ...
            <li><Link to={"#linearalgebra"}>Linear Algebra</Link></li>
        </ul>
...
"/>
        ...
        <h3 id={"basicgeometry"}>Basic Geometry</h3>

        <h4>Simple Rules</h4>

        <ul className="text-list">
            <li>Angles in a triangle add up to 180 degrees.</li>
            <li>Angles on a straight line add up to 180 degrees.</li>
            <li>Angles in a quadrilateral add up to 360 degrees.</li>
            <li>Angles around a point add up to 360 degrees.</li>
            <li>Isosceles triangles have two sides the same and two angles the same.</li>
            <li>Equilateral triangles have three sides the same and three angles the same.</li>
            <li>Opposite angles are equal when two lines cross.</li>
            <li>Alternate angles are equal when two lines are crossed by another line. The are found in Z shape.</li>
            <li>Corresponding angles are equal when two lines are crossed by another line. They are found in F shape.</li>
            <li>Allied angles add up to 180 degrees when two lines are crossed by another line. They are found in C or U shape.</li>
        </ul>

        <h4>Polygon</h4>
        <p><strong>Polygon</strong> is a many side shape. They can be regular where all sides and angles are the same. Or irregular where the sides and angles are different.</p>

        <p><strong>Interior</strong> and <strong>Exterior</strong> Angle rules.</p>

        <ul className='text-list'>
            <li>Sum of exterior angles add up to 360 degress</li>
            <li>Sum of interior angles is <InlineMath math="(n-2) \times 180^\circ"></InlineMath></li>
            <li>Interior angle is <InlineMath math="180^\circ - exterior angle"></InlineMath></li>
        </ul>

        <p>One rule exists for regular polygone only exterior angle = <InlineMath math="\frac{360}{n}"></InlineMath></p>
        ...
        <p>When graphing <InlineMath math="f(x) = b^x" /> when b is equal to 1 then you will have a horizontal line as one to the power of anything is still.</p>

        <p>When plotting this graph every combination will always pass through the point <InlineMath math="(0,1)" /> as anything to the power of zero is one.</p>

        <p>If <i>b</i> is greater than 1 then the graph will rise rapidly for positive <i>x</i> and the negative x-axis is an asymptote, this is called exponential growth.</p>

        <p>If <i>b</i> is <InlineMath math="0 \lt b \lt 1" /> rises rapidly for negative <i>x</i> and the positive x-axis is an aymptote. This is <strong>exponential decay</strong>.</p>

        <p>Note that <InlineMath math="y = (\frac{1}{b})^x" /> is the same as <InlineMath math="y = \frac{1}{b^x}" /> is the same as <InlineMath math="y = b^{-x}" /></p>

        <p>To solve exponential functions you need to remember the natual log law of indices.</p>

        <p>The special value for b is the exponential constant or euler number <InlineMath math="e" /> this number to four decimal places is <InlineMath math="2.718" />. If you graph this function and its gradient then you will see that it is its own derivative <InlineMath math="y = e^x" /> differentitated is <InlineMath math="\frac{dy}{dx} = e^x" />.</p>


        <h4>Product Rule</h4>
        <BlockMath math="ln(xy) = ln(x) + ln(y)" />
        <h4>Quotient Rule</h4>
        <BlockMath math="ln(\frac{x}{y}) = ln(x) - ln(y)" />

        <h4>Power Rule</h4>
        <BlockMath math="ln(x^y) = y \times ln(x)" />

        <p>Some examples of the power rule are found below.</p>

        <BlockMath math="3^x = 243" />
        <BlockMath math="\ln(3^x) = \ln(243)" />
        <BlockMath math="x \times \ln(3) = \ln(243)" />
        <BlockMath math="x = \frac{\ln(243)}{\ln(3)}" />
        <BlockMath math="x = 5" />

        <p>Another example.</p>

        <BlockMath math="27^x = \frac{1}{9}" />
        <BlockMath math="\ln(27^x) = \ln(\frac{1}{9})" />
        <BlockMath math="x \times \ln(27) = \ln(\frac{1}{9})" />
        <BlockMath math="x = \frac{\ln(\frac{1}{9})}{\ln(27)}" />
        <BlockMath math="x = \frac{\ln(\frac{1}{9})}{\ln(27)}" />
        ...
        <p><InlineMath math={"\R^2"}></InlineMath> the two dimensional real coordinate space is just the coordinate

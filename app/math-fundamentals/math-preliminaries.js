...
const MathPreliminaries  = () => (
 ...
 <br />
        <strong>Proof: </strong><br /> <Latex> $1 + 3 + 5 +... + (2(n + 1) - 1)$</Latex>(The left side from above)  <br />
        <Latex>   $= 1 + 3 + 5 + ... + (2n - 1) + (2n + 2 - 1)$</Latex> (simplify)<br />
                            <Latex>   $= n^2 + (2n + 2 - 1)$</Latex>  (by assumption)<br />
                            <Latex>   $= n^2 + 2n + 1$</Latex> <br />
        <Latex>   $= (n + 1)^2$</Latex>(See math prerequisites we did this example of simplification from the line above.) <br />
